...
class MusicPlayer:
    ...
    def play_current(self):
        ...
        # TODO: Get the current song from the playlist
...
class PlayerUI(MDBoxLayout):
    ...
    def update_ui(self):
        ...
        self.next_song.text = f"Next: {song.next.title}" if song and song.next else "Next: None"
        self.prev_song.text = f"Previous: {song.prev.title}" if song and song.prev else "Previous: None"
